<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'GET') {
        ...
        $inputValue = $_GET['inputValue'];  // Parameter for and when a variable is needed
        ...
        if (array_key_exists($queryId, $queries)) {
            ...
            $response = [
                'success' => true,
                'data' => $result // Provide the result data here
            ];
